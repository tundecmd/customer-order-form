  ...
  return (
    <form className='form' onSubmit={handleSubmit}>
        <div className="formGroup">
            <label htmlFor="label" className="formLabel">FirstName</label>
            <input type="text" value={firstName} onChange={e => setFirstName(e.target.value)} className='formField' />
        </div>
        <div className="formGroup">
            <label htmlFor="label" className="formLabel">LastName</label>
            <input type="text" value={lastName} onChange={e => setLastName(e.target.value)} className='formField' />
        </div>
        <div className="formGroup">
        ...
        <div className="formGroup">
            <label htmlFor="label" className="formLabel">Username</label>
            <input type="text" value={username} onChange={e => setUsername(e.target.value)} className='formField' />
        </div>
        {/* <div className="formGroup">
