...
import ConsecutiveSnackbarMessages from "components/ConsecutiveSnackbarMessages";
import smoothScrollTop from "utils/functions/smoothScrollTop";
import persons from "dummy_data/persons";
// import LazyLoadAddBalanceDialog from "components/LazyLoadAddBalanceDialog";
...
function Main(props) {
    ...
    const selectDashboard = useCallback(() => {
        ...
        if (!hasFetchedCardChart) {
            ...
            import("components/CardChart").then((Component) => {
