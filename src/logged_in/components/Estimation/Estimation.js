...
const PaymentOptionFetched = paymentOptions.filter((paymentOption) => {
    return customerOrder && (paymentOption.label === customerOrder.Payment_Method)
  });
...
console.log('customerOrder', customerOrder)
  const [form, setForm] = useState({
    ...
    Vehicle_Registered_Date: customerOrder ? customerOrder.Vehicle_Registratered_Date : "",
                ...
                <Box>
                    <Accordion>
                        ...
                        <form className='form' onSubmit={onSubmitForm}>
                            ...
                            <div className="formGroup">
                                <label htmlFor="label" className="formLabel">Vehicle Registered Date</label>
                                <input type="date" name="Vehicle_Registratered_Date" value={form.Vehicle_Registratered_Date} onChange={onUpdateField} className='formField' />
                            </div>
                            <div className="formGroup">
                    ...
                    <Accordion>
                        ...
                        <form className='form' onSubmit={onSubmitForm}>
                            <div className="formGroup">
                                ...
                                <input type="date" name="Vehicle_Registratered_Date" className='formField' />
                            </div>
                            <div className="formGroup">
                                <label htmlFor="label" className="formLabel">Delivery Time</label>
                                <input type="time" name="Delivery_Time"  className='formField' />
                            </div>
                            <div className="formGroup">
                                <label htmlFor="label" className="formLabel">Payment Method</label>
                                <Select
                                    value={selectedPayment_Method}
                                    onChange={e => setSelectedPayment_Method(e.value)}
