...
import { getCustomerOrder, getCustomerOrderById } from "state/actions";

function CustomerOrdersEstimation(props) {
    const {
        selectDashboard,
        CardChart,
        statistics,
...
CustomerOrdersEstimation.propTypes = {
...
export default CustomerOrdersEstimation;
