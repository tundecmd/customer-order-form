...
function ReceivedVehicles(props) {
    ...
    const handleOpenReceivedVehicleModal = useCallback(
        (rowData) => {
                ...
                <DialogContent>
                    ...
                    >
                        ...
                        <Grid item xs={6} p={0} m={0}>
                            <ColorfulChip
                                label={`${customerOrder.Stage}`}
                                color={theme.palette.secondary.main}
                            />
                        </Grid>
                        <Grid item xs={4}>
                            <Typography pb={1} sx={{ fontSize: 14 }}>
                                Car Details
                            </Typography>
                        </Grid>
                        <Grid item xs={4}>
                        ...
                        <Grid item xs={4}>
                            <Typography pb={1} sx={{ fontSize: 14 }}>
                                {customerOrder.Frame_No_VIN}
                            </Typography>
                            <Typography pb={1} sx={{ fontSize: 14 }}>
                                {customerOrder.Model_Number}
                            </Typography>
                            <Typography pb={1} sx={{ fontSize: 14 }}>
                                {customerOrder.Model_Name}
                            </Typography>
                            <Typography pb={1} sx={{ fontSize: 14 }}>
                                {customerOrder.Engine_No}
                            </Typography>
                            <Typography pb={1} sx={{ fontSize: 14 }}>
                                MUS657GT
                            </Typography>
                ...
                <DialogContent>
                    ...
                    <FirstTab
                        ...
                        receiveVehicleSubmitParentCallBack={
                            handleReceiveVehicleSubmitCallBack
                        }
                    />
                </DialogContent>
            </Dialog>
