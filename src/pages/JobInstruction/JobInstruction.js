                        ...
                        <Accordion>
                            ...
                            <form className="form" onSubmit={onSubmitForm}>
                                ...
                                <div className="formGroup">
                                    ...
                                    <input
                                        type="text"
                                        name="Key_Assigned_No"
                                        value={form.Key_Assigned_No}
                                        onChange={onUpdateField}
                                        className="formField"
                                    />
                                </div>
                        ...
                        <Accordion>
                            ...
                            <form className="form" onSubmit={onSubmitForm}>
                                ...
                                <div className="formGroup">
                                    ...
                                    <textarea
                                        rows={4}
                                        name="Other_Findings_Advice"
                                        type="text"
                                        value={form.Other_Findings_Advice}
                                        onChange={onUpdateField}
                                        className="formField"
                                    ></textarea>
                                </div>
